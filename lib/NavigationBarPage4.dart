...
import 'API.dart';
class NavigationBarPage4 extends StatefulWidget { 
  final String title;
  // ignore: non_constant_identifier_names
  final String? display_Name;

  // ignore: non_constant_identifier_names
  const NavigationBarPage4({super.key, required this.title, this.display_Name});

  @override
  // ignore: library_private_types_in_public_api
  _NavigationBarPage4State createState() => _NavigationBarPage4State();
}

class _NavigationBarPage4State extends State<NavigationBarPage4> {
...
Column(
  ...
  'assets/demo2.png',
  fit: BoxFit.cover, 
  width: double.infinity, // This will make the image cover the whole width
),
